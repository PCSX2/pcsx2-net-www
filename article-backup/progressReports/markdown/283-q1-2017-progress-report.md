::: {.single-article}
::: {.item-page .clearfix}
## [Q\...1? 2017 progress report](/283-q1-2017-progress-report.html) {#q...1-2017-progress-report .contentheading}

::: {style="text-align:center;"}
:::

![Progress report q1
2017](/images/stories/frontend/progress_reports/q1-2017/progress-rep-q1-2017.jpg){width="563"
height="104"}

The wait is over! (if there were people still waiting on us
![Razz](https://pcsx2.net/images/stories/frontend/smilies/tongue.gif){.yvSmiley
width="20" height="20"} ) The Q1 2017 progress report is here, albeit we
are late once more. Don\'t blame us, blame all these wonderful fixes you
will find below:

[ [ [ Core ]{style="text-decoration: underline;"}
]{style="font-weight: bold;"} ]{style="font-size: xx-large;"}\
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [Core: VIF unpack speed
optimization](https://github.com/PCSX2/pcsx2/pull/1706)
...
[ \[Bug-Fix\] ]{style="color: #ff3333;"} [ [VU0: Fix CFC2 transfers from
TPC register](https://github.com/PCSX2/pcsx2/pull/1835)
]{style="font-weight: bold; text-decoration: underline;"} by
[volodymyrkutsenko](https://github.com/volodymyrkutsenko)
...
\"Street Fighter EX 3\" and \"R: Racing Evolution\". We are sincerely
sorry for fixing this long standing bug plaguing Street Fighter EX3,
which started with [missing
...
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [GSdx: OSD
Manager](https://github.com/PCSX2/pcsx2/pull/1431)
]{style="text-decoration: underline;"} ]{style="font-weight: bold;"} by
[Maxxus](https://github.com/JasonBrownDeveloper) and
...
\
The OSD consists of 2 functions, the \"Log\" and the \"Monitor\". The
\"Log\", enabled by default, prints the console log messages returned by
several keys(F1-F3 Save States, F4/Tab Framelimiter) on screen. And
\"Monitor\", disabled by default, prints the current Framerate and
EE/GS/VU percentages on screen. The OSD settings can be configured in
the [ OSD Configuration ]{style="font-weight: bold;"} dialog located on
...
\
[![Kingdom Hearts 2
OSD](/images/stories/frontend/progress_reports/q1-2017/KH-OSD2-s.png "Kingdom Hearts 2 OSD"){width="353"
height="205"}](/images/stories/frontend/progress_reports/q1-2017/KH-OSD2.png)
[![OSD](/images/stories/frontend/progress_reports/q1-2017/OSD_monitor-s.jpg "OSD"){width="353"
height="199"}](/images/stories/frontend/progress_reports/q1-2017/OSD_monitor.jpg)\
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [GSdx: Texture cache
speed optimization](https://github.com/PCSX2/pcsx2/pull/1766)
]{style="text-decoration: underline;"} ]{style="font-weight: bold;"} by
[Gregory](https://github.com/gregory38)\
\
...
[ \[Bug-Fix\] ]{style="color: #ff3333;"} [ [Windows Skylake CPU slow
software renderer fix](https://github.com/PCSX2/pcsx2/pull/1741)
]{style="font-weight: bold; text-decoration: underline;"} by
...
[ \[Bug-Fix\] ]{style="color: #ff3333;"} [ [Software renderer thread
synchronization fix](https://github.com/PCSX2/pcsx2/pull/1855)
]{style="font-weight: bold; text-decoration: underline;"} by
[Gregory](https://github.com/gregory38)
...
the game [ \"Blood Will Tell\" ]{style="font-weight: bold;"} , random
graphical glitches were present when multiple threads were used, which
indicated that there was a race condition in the code.\
\
...
\
[![Blood Will
Tell](/images/stories/frontend/progress_reports/q1-2017/blood_will_tell_before-s.png "Blood Will Tell"){width="353"
height="265"}](/images/stories/frontend/progress_reports/q1-2017/blood_will_tell_before.png)
[![Blood Will
Tell](/images/stories/frontend/progress_reports/q1-2017/blood_will_tell_after-s.png "Blood Will Tell"){width="353"
height="265"}](/images/stories/frontend/progress_reports/q1-2017/blood_will_tell_after.png)\
\
[ \[Bug-Fix\] ]{style="color: #ff3333;"} [ [Improved software renderer
float handling](https://github.com/PCSX2/pcsx2/pull/1843)
]{style="font-weight: bold; text-decoration: underline;"} by
[Gregory](https://github.com/gregory38)
...
sampling issues which were observed in [ Xenosaga Episode 1
]{style="font-weight: bold;"} and [ Jak 3 ]{style="font-weight: bold;"}
.\
\
...
underflow/overflow issues. This fixed the major texture issues in [
Galerians: Ash ]{style="font-weight: bold;"} and [ Let\'s make a
J-League Pro Soccer Club \'04 ]{style="font-weight: bold;"} .\
\
[![Jak
3](/images/stories/frontend/progress_reports/q1-2017/jak3-before-s.png "Jak 3"){width="353"
height="265"}](/images/stories/frontend/progress_reports/q1-2017/jak3-before.png)
[![Jak
3](/images/stories/frontend/progress_reports/q1-2017/jak3-after-s.png "Jak 3"){width="353"
height="265"}](/images/stories/frontend/progress_reports/q1-2017/jak3-after.png)
[![Galerians
Ash](/images/stories/frontend/progress_reports/q1-2017/gash_before_s.jpg "Galerians Ash"){width="353"
height="185"}](/images/stories/frontend/progress_reports/q1-2017/gash_before.jpg)
[![Galerians
Ash](/images/stories/frontend/progress_reports/q1-2017/gash_after_s.jpg "Galerians Ash"){width="353"
height="185"}](/images/stories/frontend/progress_reports/q1-2017/gash_after.jpg)\
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [GSdx: Removal of SSSE3
and AVX configurations](https://github.com/PCSX2/pcsx2/pull/1790)
...
with older CPUs. This, however, confused new users, who didn\'t know
what version of the plugin they should select.\
\
...
\
[ \[Upstream\] ]{style="color: #9970f9;"} [ [Blacklist AMD
...
\
\
[ [ [ LilyPad ]{style="font-size: x-large;"}
]{style="font-weight: bold;"} ]{style="text-decoration: underline;"}\
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [LilyPad: neGcon
controller support](https://github.com/PCSX2/pcsx2/pull/1751)
]{style="text-decoration: underline;"} ]{style="font-weight: bold;"} by
[FlatOut](https://github.com/FlatOutPS2)\
\
...
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [LilyPad: UI
Changes](https://github.com/PCSX2/pcsx2/pull/1831)
]{style="text-decoration: underline;"} ]{style="font-weight: bold;"} by
[FlatOut](https://github.com/FlatOutPS2)\
\
Several new options have been added to the LilyPad user interface. The
most notable is the addition of a [ Quick Setup
]{style="font-weight: bold;"} button on the Pad tabs. This button allows
for quickly setting up all the default pad buttons one after the other
...
has finished.\
\
Another new option is [ Exclude Input ]{style="font-weight: bold;"} .
This option allows for deactivating a specific input on your device, so
that it will be ignored when trying to bind other inputs. This can be
helpful when binding controls for a device with an input that\'s
difficult to center like an accelerator, or just always active like a
faulty button or analog stick.\
\
The [ L3 Toggles Turbo ]{style="font-weight: bold;"} hack, which
triggered Turbo mode (200% speed) in PCSX2, has been removed. It has
been replaced by a new Turbo button in the Special Inputs section of the
Pad tabs. This new Turbo button still fulfills the same function as the
old Turbo hack, but it can be assigned to any input the user desires
instead of just the L3 button which the hack used.\
\
Last but not least is the introduction of a [ Restore Defaults
]{style="font-weight: bold;"} button on the general tab. This option
makes it possible to reset all current LilyPad setings and bindings to
those of the default Lilypad settings file without having to go to the
inis folder and manually removing the file.\
\
[ \[Enhancement\] ]{style="color: #018ddd;"} [ [ [LilyPad: Core
improvements](https://github.com/PCSX2/pcsx2/pull/1831)
]{style="text-decoration: underline;"} ]{style="font-weight: bold;"} by
[FlatOut](https://github.com/FlatOutPS2)\
\
...
available.\
\
The [ Use analog mode if possible ]{style="font-weight: bold;"} option
has been extended to work for PS2 games and PS1 games running in PCSX2.\
\
