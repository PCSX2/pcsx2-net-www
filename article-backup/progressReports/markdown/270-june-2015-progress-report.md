::: {.single-article}
::: {.item-page .clearfix}
## [June 2015 progress report](/270-june-2015-progress-report.html) {#june-2015-progress-report .contentheading}

::: {style="text-align:center;"}
:::

![6-2015 progress
report](/images/stories/frontend/progress_reports/6-2015/6-2015-logo.jpg "6-2015 progress report"){width="562"
height="104"}
...
can\'t, use software mode and expect it to be ridiculously demanding.
For those of you unfamiliar with it, the Snowblind engine was used for
games like Baldur\'s Gate: Dark Alliance, Champions of Norrath,
Champions: Return to Arms, and a few miscellaneous others. The Snowblind
engine does some pretty crazy stuff on the PS2, like using 2x Super
Sample Anti Aliasing! Because of that, it\'s very demanding and even
ultra powerful rigs would have issues running these games in software
mode. Running them in hardware mode would result in only half the screen
being visible because of the way the engine achieves the 2x SSAA.
...
channels - red, green, blue, alpha. Also it\'s important to remember
that the output of the blending unit can be out of the valid range.
Normally this is no problem - a GPU will clamp it. But things get a
little different in the case of the GS which also wraps it.\
\
\
\
  ...
  :  [ [ Standard GPU ]{style="font-size: large;"}
  ]{style="color: #ffd700;"}
  ...
  :  [ [ Graphics Synthesizer ]{style="font-size: large;"}
  ]{style="color: #ff4500;"}
...
\
[![GS-GPU
chart1](/images/stories/frontend/progress_reports/6-2015/gpu-gs-chart_s.png "GS-GPU chart1"){width="354"
height="305"}](/images/stories/frontend/progress_reports/6-2015/gpu-gs-chart.png)
[![GS-GPU
chart2](/images/stories/frontend/progress_reports/6-2015/gpu-gs-chart2_s.png "GS-GPU chart2"){width="350"
height="455"}](/images/stories/frontend/progress_reports/6-2015/gpu-gs-chart2.png)\
\
...
\
[![fbmask](/images/stories/frontend/progress_reports/6-2015/fbmask_fixed_s.jpg "fbmask"){width="353"
height="206"}](/images/stories/frontend/progress_reports/6-2015/fbmask_fixed.jpg)
[![fbmask](/images/stories/frontend/progress_reports/6-2015/fbmask_broken_s.jpg "fbmask"){width="353"
height="206"}](/images/stories/frontend/progress_reports/6-2015/fbmask_broken.jpg)
[![castlevania](/images/stories/frontend/progress_reports/6-2015/castlevania_fixed_s.jpg "castlevania"){width="353"
height="246"}](/images/stories/frontend/progress_reports/6-2015/castlevania_fixed.jpg)
[![castlevania](/images/stories/frontend/progress_reports/6-2015/castlevania_broken_s.jpg "castlevania"){width="353"
height="246"}](/images/stories/frontend/progress_reports/6-2015/castlevania_broken.jpg)\
\
[![moh](/images/stories/frontend/progress_reports/6-2015/moh_fixed_s.jpg "moh"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/moh_fixed.jpg)
[![moh](/images/stories/frontend/progress_reports/6-2015/moh_broken_s.jpg "moh"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/moh_broken.jpg)\
\
[![nemo](/images/stories/frontend/progress_reports/6-2015/nemo_fixed_s.jpg "nemo"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/nemo_fixed.jpg)
[![nemo](/images/stories/frontend/progress_reports/6-2015/nemo_broken_s.jpg "nemo"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/nemo_broken.jpg)\
\
[![fifa](/images/stories/frontend/progress_reports/6-2015/fifa_street_fixed_s.jpg "fifa"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/fifa_street_fixed.jpg)
[![fifa](/images/stories/frontend/progress_reports/6-2015/fifa_street_broken_s.jpg "fifa"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/fifa_street_broken.jpg)\
\
[![hulk](/images/stories/frontend/progress_reports/6-2015/hulk_fixed_s.jpg "hulk"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/hulk_fixed.jpg)
[![hulk](/images/stories/frontend/progress_reports/6-2015/hulk_broken_s.jpg "hulk"){width="354"
height="206"}](/images/stories/frontend/progress_reports/6-2015/hulk_broken.jpg)\
\
...
options into a single one called \"Blending Unit Accuracy\" with
different modes with respect to it\'s accuracy and impact on
performance. You can follow the progress
...
\
![gsdx_renderer](/images/stories/frontend/progress_reports/6-2015/gsdx_renderer_displ.png "gsdx_renderer"){width="347"
height="243"}
![gsdx-console-dsiplay](/images/stories/frontend/progress_reports/6-2015/gsdx_console_displ.png "gsdx-console-dsiplay"){width="347"
height="215"}\
\
\
...
at the [ GSdx Plugin settings ]{style="font-style: italic;"} . But this
wasn\'t actually as simple a case as it could have been. There is a
Shortcut key (F9) for toggling the mode of a specific renderer from
...
solution from a developer\'s perspective, but it will surely be good
news for users who were waiting to play these games.\
\
