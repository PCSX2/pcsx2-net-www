::: {.single-article}
::: {.item-page .clearfix}
## [July-August 2015 progress report](/271-july-august-2015-progress-report.html) {#july-august-2015-progress-report .contentheading}

::: {style="text-align:center;"}
:::

![6-2015 progress
report](/images/stories/frontend/progress_reports/7-8-2015/7-8-2015-logo.jpg "6-2015 progress report"){width="562"
height="104"}

Hello everyone! Welcome to PCSX2\'s July-August 2015 progress report!
Since we were late again (
![Razz](https://pcsx2.net/images/stories/frontend/smilies/tongue.gif){.yvSmiley
width="20" height="20"} ) we\'ll include the first half of August in
this report as well. So sit back, buckle up and hold on as we go over
the changes that happened in the months of July and August! First we
will go over some more magic in the realm of GSdx.
...
around more this time. Welcome back! ![Very
...
\
[ Blending unit accuracy options ]{style="text-decoration: underline;"}
...
\
[ Implement an ultra accurate blending feature in high accurate blending
with a small performance hit ]{style="text-decoration: underline;"} by
[Gregory](https://github.com/gregory38)\
\
...
\
[ HDR colclip ]{style="text-decoration: underline;"} by
[Gregory](https://github.com/gregory38)\
\
...
based algorithm.\
\
Let\'s take a look at the improvements made on the algorithm by
comparing it to the GS in a scenario of blending two fragments of color
20 and 255 on a target of color 250. Notice that the new algorithm gives
us the result using 2 passes, that\'s why it is also more CPU demanding
than the old code.
...
go beyond the minimum and maximum limits. (no overflow)
  ...
  :  [ [ New HDR based algorithm ]{style="font-size: large;"}
  ]{style="color: #1d41cb;"}
...
\
[![Gow
HDR](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-broken1-s.jpg "Gow HDR"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-broken1.jpg)
[![Gow
HDR](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-fixed1-s.jpg "Gow HDR"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-fixed1.jpg)
[![Gow
HDR](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-broken2-s.jpg "Gow HDR"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-broken2.jpg)
[![Gow
HDR](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-fixed2-s.jpg "Gow HDR"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/gow1-hdr-fixed2.jpg)\
\
Relevant PR:\
...
\
[ Software renderer fixes ]{style="text-decoration: underline;"} by
[Gregory](https://github.com/gregory38) &
...
\
[![Haunting
Ground](/images/stories/frontend/progress_reports/7-8-2015/haunting-ground-broken-s.jpg "Haunting Ground"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/haunting-ground-broken.jpg)
[![Haunting
Ground](/images/stories/frontend/progress_reports/7-8-2015/haunting-ground-fixed-s.jpg "Haunting Ground"){width="353"
height="199"}](/images/stories/frontend/progress_reports/7-8-2015/haunting-ground-fixed.jpg)
...
\
[ GSdx: Post-processing updates ]{style="text-decoration: underline;"}
...
\
\
[ [ New feature: ]{style="font-size: x-large;"}
]{style="font-weight: bold;"}\
\
[ Folder memory cards ]{style="text-decoration: underline;"} by
...
\
\
[ [ Onepad (Linux): ]{style="font-size: x-large;"}
]{style="font-weight: bold;"}\
\
