...
authors:
- vaser
date: 2022-03-18 14:14:03.480761
description: If you're reading this post, that means we've migrated to our new website.  Expect
  further changes and improvements as we iron out the details.
draft: false
image: ./feature-poor-perf-splash.webp
tags:
- devblog
title: New Website!
---
...
<SliderCompare before={require("./img/old.webp").default} after={require("./img/new.webp").default} />
