...
To manually map a controller, first click on the button you want to map on the virtual controller and then press the corresponding button on your actual controller that you want to bind with the virtual controller. You'll have to do this manually one by one for each buttons.
