...
:::tip
You can add the `-parallel 4` as a parameter for it to run multiple dumps at once (recommended).
Optinally, you can replace 4 with the number you want to do at once, but this is the recommended value.
:::
