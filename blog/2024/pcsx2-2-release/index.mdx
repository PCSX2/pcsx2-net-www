...
But now, wxWidgets is GONE. No more desktop experience reminding you of what Windows desktop apps looked like in 2006. Qt brings with it a much more slick appearance, more efficient UI backend, and provided the perfect opportunity to redo all our menus and widgets. The addition of themes allows you to personalize your PCSX2 to your liking. The result is by far our best user experience to date! Massive thanks to Stenzek for bringing his Qt expertise from DuckStation, and leading the charge on PCSX2's new Qt design!
