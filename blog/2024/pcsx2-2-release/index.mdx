...
It has been almost four whole years since the last stable PCSX2 revision released. A lot of things can happen in four years, but we could not have predicted just how much progress would be made in that time. PCSX2 has received over 5500 changes, passed 100 million downloads, and celebrated its 20th aniversary! There are lots of design changes, technical discoveries, and more to discuss. So much so, it is hard to keep track of everything! So let's jump right in to it and get started with the highlights from four years of development!
...
But now, wxWidgets is GONE. No more desktop experience reminding you of what Windows desktop apps looked like in 2006. Qt brings with it a much more slick appearance, more efficient UI backend, and provided the perfect opportunity to redo all our menus and widgets. The addition of themes allows you personalize your PCSX2 to your liking. The result is by far our best user experience to date! Massive thanks to Stenzek for bringing his Qt expertise from DuckStation, and leading the charge on PCSX2's new Qt design!
