...
description:
  PCSX2 is perhaps one of the few projects that releases a constant series
  of videos demonstrating development progress
draft: false
tags:
  - devblog
...
When using _zeroGS_ you merely have to press **F7** to start recording
...
_zeroGS_ automatically speeds up footage to "normal" speeds, which
causes issues if you want to record audio in sync with the video
footage. _P.E.Op.S SPU2 DSound Driver_ records at "emulated" speed and
...
the CPU settings dialog, and setting _P.E.Op.S SPU2 DSound Driver_ to
**Thread Mode** . To _ensure_ sync with the video, set _P.E.Op.S SPU2
DSound Driver_ to start recording **before** you confirm the codec you
wish to record with.
...
demonstrating _Final Fantasy XII_ no longer suffering from vanishing
text
