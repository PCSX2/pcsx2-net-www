...
<PCSX2PRLink authors="KamFretoZ" prNums="11848">
  ### Savestate Compression Options (5)
</PCSX2PRLink>
...
Capping off 2.2 is improved wheel input support, thanks to the meticulous work of first-time contributor badfontkeming. The subject of this improvement, [force feedback](https://en.wikipedia.org/wiki/Haptic_technology#Force_feedback) (FFB), is a type of haptic feedback, often used in racing games to simulate the movement of the steering wheel when performing actions like cornering. These games usually use a constant force
...
- [#12157](https://github.com/PCSX2/pcsx2/pull/12157) – Peripherals contributor Florin9doi adds support for the MemCard PRO2.
