...
- [_Rez_ Trance Vibrator](https://www.theverge.com/2016/9/25/13046770/rez-trance-vibrator-ps2)
...
In games with wheel support, such as [_Gran Turismo 4_](https://wiki.pcsx2.net/Gran_Turismo_4), modern wheels would often feel unresponsive or lack proper feedback due to incomplete or broken FFB support in older PCSX2 builds. This new implementation introduces more accurate FFB handling and restores the feeling of physical interaction — improving immersion and playability for racing fans.

### Various Smaller Improvements in 2.2 (4)
...
- [#11614](https://github.com/PCSX2/pcsx2/pull/11614) – Peripherals contributor Florin9doi creates a custom UI for [_Buzz!_](https://en.wikipedia.org/wiki/Buzz!) devices.
...
- [#11839](https://github.com/PCSX2/pcsx2/pull/11839) – Graphics expert LightningTerror fixes a longstanding graphical issue in [_Knights of the Template: Infernal Crusade_](https://wiki.pcsx2.net/Knights_of_the_Temple:_Infernal_Crusade).
