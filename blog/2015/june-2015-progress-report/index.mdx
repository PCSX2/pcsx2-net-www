...
description:
  As promised in last month's update, welcome to PCSX2's very first monthly
  progress report!
draft: false
tags:
  - progress-report
...
<SliderCompare
  before={require("./img/fbmask_broken_s.jpg").default}
  after={require("./img/fbmask_fixed_s.jpg").default}
/>

<SliderCompare
  before={require("./img/castlevania_broken_s.jpg").default}
  after={require("./img/castlevania_fixed_s.jpg").default}
/>

<SliderCompare
  before={require("./img/moh_broken_s.jpg").default}
  after={require("./img/moh_fixed_s.jpg").default}
/>

<SliderCompare
  before={require("./img/nemo_broken_s.jpg").default}
  after={require("./img/nemo_fixed_s.jpg").default}
/>

<SliderCompare
  before={require("./img/fifa_street_broken_s.jpg").default}
  after={require("./img/fifa_street_fixed_s.jpg").default}
/>

<SliderCompare
  before={require("./img/hulk_broken_s.jpg").default}
  after={require("./img/hulk_fixed_s.jpg").default}
/>
