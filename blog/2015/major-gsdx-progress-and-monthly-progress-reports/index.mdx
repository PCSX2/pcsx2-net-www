...
description:
  Hello everyone! I know our news updates have been few and far between
  as of late, but that's going to change starting now!
draft: false
tags:
  - progress-report
...
<ImageCompare
  left={require("./img/Tekken-5-Without-Align-Hack_s.webp").default}
  right={require("./img/Tekken-5-With-Align-Hack_s.webp").default}
/>
...
<ImageCompare
  left={require("./img/ATon-no-round-sprite_s.jpg").default}
  right={require("./img/ATon-round-sprite_s.jpg").default}
/>
...
<ImageCompare
  left={require("./img/MGS-bad-blend_s.webp").default}
  right={require("./img/MGS-good-blend_s.webp").default}
/>
...
<ImageCompare
  left={require("./img/sotc_before_s.webp").default}
  right={require("./img/sotc_after_s.webp").default}
/>
