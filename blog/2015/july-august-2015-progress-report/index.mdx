...
description: Hello everyone! Welcome to PCSX2's July-August 2015 progress report!
draft: false
tags:
  - progress-report
...
<SliderCompare
  before={require("./img/gow1-hdr-broken1-s.jpg").default}
  after={require("./img/gow1-hdr-fixed1-s.jpg").default}
/>

<SliderCompare
  before={require("./img/gow1-hdr-broken2-s.jpg").default}
  after={require("./img/gow1-hdr-fixed2-s.jpg").default}
/>
...
<SliderCompare
  before={require("./img/haunting-ground-broken-s.jpg").default}
  after={require("./img/haunting-ground-fixed-s.jpg").default}
/>
