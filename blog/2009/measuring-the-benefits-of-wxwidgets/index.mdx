...
description:
  One of the major changes planned for the next release of PCSX2 is a complete
  overhaul of the gui/frontend, switching from the current "native" Windows/Linux
  interfaces to a single unified interface that's (more or less) the same for both
  platforms
draft: false
tags:
  - devblog
...
So what _are_ the benefits of the new PCSX2 interface in development?
