...
description:
  ...
  over the years is its event handling system
draft: false
tags:
  - devblog
title: Events Plenty
...
vary greatly since each cycle of the cpu consists of several _stages_
...
instructions in pre-compiled _bursts_ . This is so important to
