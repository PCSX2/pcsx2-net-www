...
description:
  Some days ago we were contacted by a Croatian gaming site goodgame.hr
  and were asked to give an interview about PCSX2
draft: false
tags:
  - devblog
...
_1.Hello. Can you tell us something about yourself before we get on with
the interview?_
...
_2.Can you briefly tell us about development of PCSX2 emulator till this
day?_
...
_3.How much people are working on this project? When has it all
started?_
...
_4.Is it hard to work on the emulator development and what are the most
common problems you face?_
...
_5.Where there any differences between developing PCSX2 and PCSX?_
...
_6.Considering the amount of information and options regarding the
...
regarding graphics. Is PCSX2 more complicated because its better?_
...
_7.Do you think that you reached the limit in emulator development or
are there more things to add in PCSX2?_
...
_8.How much money do you make on developing PCSX2? Is there any profit?
If not, why do you do it?_
...
_9.Personally, on my configuration (Core 2 Duo 2.66, Nvidia GeForce
...
_10.What is your attitude towards new HD editions of different games?
Maybe they would not be developed if they haven't seen the graphic
improvement on your PCSX2?_
...
_11.What percentage of games is compatible with the PCSX2?_
...
_12.What is SONY's official attitude towards PCSX2?_
...
_13.Do you think that there is anything illegal with your emulator? Lets
...
_14.Considering the small number of people who know how emulators are
...
_15.When will the next version go out?_
...
_16.Is it realistic to expect a PlayStation 3 emulator in a near
future?_
