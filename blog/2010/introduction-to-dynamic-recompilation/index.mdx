...
description:
  his blog post is an introduction to dynamic recompilers (dynarecs), and
  hopes to provide some insight on how they work and why pcsx2 uses them to speed
  up emulation
draft: false
tags:
  - devblog
...
MOV dest_reg, src1_reg // Move source register to destination
register
ADD dest_reg, src1_reg, src2_reg // Add source1 and source2
...
To actually emulate this processor we can use an **_interpreter_** . An
interpreter simply fetches each _instruction opcode_ and executes them
