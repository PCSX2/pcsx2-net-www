...
<ImageCompare
  left={require("./img/5649-1-QtSettings.png").default}
  right={require("./img/5649-2-QtSettings.png").default}
/>
...
<ImageCompare
  left={require("./img/3895-BurnoutBlackSky.png").default}
  middle={require("./img/3895-BurnoutFixedSky.png").default}
  right={require("./img/3895-TheGetAwayPause.png").default}
/>
...
<Image cols={6} src={require("./img/LogoVulkanGSDX.png").default} />
...
<SliderCompare
  before={require("./img/5411-HumansBefore.png").default}
  after={require("./img/5411-HumansAfter.png").default}
/>
...
<Image cols={6} src={require("./img/5545-AbuseCache.png").default} />
...
<Image cols={6} src={require("./img/5547-FatChocobo.png").default} />
* We do a little bit of trolling.

<SliderCompare
  before={require("./img/5547-Before.png").default}
  after={require("./img/5547-After.png").default}
/>
...
<Image cols={6} src={require("./img/5574-HashCacheOverflow.png").default} />
...
<Image cols={6} src={require("./img/5593-AutomaticRendererAndUpscalingFixes.png").default} />
...
<Image cols={6} src={require("./img/5221-Qt 2020.png").default} />
...
<ImageCompare
  left={require("./img/5461-TableBefore.png").default}
  right={require("./img/5461-TableAfter.png").default}
/>
...
<SliderCompare
  before={require("./img/5537-BabyPastelOld.png").default}
  after={require("./img/5537-BabyPastelNew.png").default}
/>

<SliderCompare
  before={require("./img/5537-LagoonOld.png").default}
  after={require("./img/5537-LagoonNew.png").default}
/>

<SliderCompare
  before={require("./img/5537-PCSX2Old.png").default}
  after={require("./img/5537-PCSX2New.png").default}
/>
