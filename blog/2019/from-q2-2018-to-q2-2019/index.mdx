...
<Image cols={6} src={require("./img/saveslots.webp").default} />> Comparison of the
old and new saveslot interface
...
<Image cols={6} src={require("./img/Blood-Will-Tell.jpg").default} />> A comparison
of graphical improvements on Blood Will Tell
