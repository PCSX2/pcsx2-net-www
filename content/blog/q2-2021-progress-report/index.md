...
{{< progress/github-link prNum="4381" title="Do not applteswapping to TX/RX FIFO writes/reads" authors="TheLastRar" >}}
...
{{< progress/github-link prNum="4364" title="Add ATA Idle Immediate (E1) stub" authors="macmenot" >}}

- Fixes HDD support for Street Fighter Alpha Anthology.

{{< progress/github-link prNum="4403" title="Consistently prefix all console output with DEV9" authors="macmenot" >}}

{{< progress/github-link prNum="4429" title="Update ATA code for wchar GHC" authors="TheLastRar" >}}

{{< progress/github-link prNum="4496" title="PCAP, check size of read packet" authors="TheLastRar" >}}

- In pcap, check size of read packet. If the size exceeds the buffer we are using, drop the packet.

{{< progress/github-link prNum="4448" title="Always use binary mode for HDD file" authors="TheLastRar" >}}

- Opening the file in binary mode is the intended behaviour (and was done in the most common situation),

{{< progress/github-link prNum="4449" title="Fix potential out of bounds access when manual DNS1 & automatic DNS2 are used together" authors="TheLastRar" >}}
...
{{< progress/github-link prNum="4442" title="Increase min HDD size to 40GiB" authors="TheLastRar" >}}

- Most games expect a HDD of 40GiB in size, and may fail to install as a result (and display a confusing error message).

{{< progress/github-link prNum="4304" title="Internal DHCP support" authors="TheLastRar" >}}

- Adds an internal DHCP similer to what CLR\DEV9 offers for pcap & tap.

{{< progress/github-link prNum="4433" title="Correctly populate DNS2 field with DNS2 IP" authors="TheLastRar" >}}

- Correctly populate DNS2 field with DNS2 IP in the DHCP section of the network ui.

{{< progress/github-link prNum="4435" title="Sleep instead of yield in RxThread" authors="TheLastRar" >}}
...
{{< progress/github-link prNum="3941" title="Folder memcards: Add an index file to track order of files" authors="CookiePLMonster" >}}
...
{{< progress/github-link prNum="3825" title="Change default of latency slider" authors="RedDevilus" >}}
...
{{< progress/github-link prNum="4474" title="Remove cycleptr, grab current cycles directly" authors="Ziemas" >}}
...
{{< progress/github-link prNum="4437" title="Make SPU use theDMA registers from iopHw." authors="Ziemas" >}}
...
{{< progress/github-link prNum="4331" title="Just enablepressure on CMD 0x4F" authors="KrossX" >}}

Fixes Warriors of Might and Magic gamepad not functioning properly.

{{< progress/github-link prNum="4466" title="Fix gamepadchoice not affecting rumble test on Linux" authors="Lahvuun" >}}
...
{{< progress/github-link prNum="4415" title="Motion buttonsupport." authors="Florin9doi" >}}

### Debuggers

{{< progress/github-link prNum="4345" title="Bios threadview support." authors="F0bes" >}}

### Misc core

{{< progress/github-link prNum="4399" title="Core / VU: Disable MTVU when VU1 Interpreter is selected." authors="F0bes" >}}

{{< progress/github-link prNum="3860" title="Remove FPUCompare Hack" authors="kozarovv" >}}

The hack is no longer needed as full Clamping mode can be used instead.

{{< progress/github-link prNum="4461" title="DifferentiateImpossible block clearing message from IOP & EE" authors="F0bes" >}}

Prefix the "Impossible block clearing failure" with "\[IOP\]" or
"\[EE\]" depending on the recompiler.

{{< progress/github-link prNum="4425" title="Fix Emulated PSXGPU Version." authors="Nobbs66" >}}

Previously it was thought that the PS2 would emulate the v2 GPU, but
hardware tests show that it emulates the V0 GPU.

{{< progress/github-link prNum="4460" title="Make DMA's instant during the BIOS" authors="refractionpcsx2,tadanokojin,PSI-Rockin" >}}
...
{{< progress/github-link prNum="4498" title="MoverecConstBuf memory near recompiler memory" authors="TellowKrinkle" >}}

- Fixes an issue where recConstBuf was too far away from the main recompiler to LEA in 64-bit builds.

{{< progress/github-link prNum="4482" title="Fix disc drivepath issues on Windows." authors="turtleli" >}}
...
{{< progress/github-link prNum="4350" title="Removepartial and full crc hack levels on release builds" authors="lightningterror" >}}

- Normal users shouldn't really need to choose partial or full since automatic already does that.

{{< progress/github-link prNum="4383" title="Some minorcleanups." authors="lightningterror" >}}

## TAS (Tool Assisted Speedrun) Utility Improvements

{{< progress/github-link prNum="4382" title="Resolve crash when closing emulator involving GUI elements" authors="xTVaser" >}}
...
{{< progress/github-link prNum="4393" title="Allow configuration of the frame advance amount" authors="xTVaser" >}}

- Adds a GUI configurable setting to control how many frames the frame-advance feature should advance.

{{< progress/github-link prNum="4392" title="Add warning when creating a save-state recording" authors="xTVaser" >}}
...
{{< progress/github-link prNum="4337" title="Remove possiblememory corruption due to strcat on provided pointer" authors="GovanifY" >}}
...
{{< progress/github-link prNum="4388" title="Adds fixesfor Energy Airforce - Aim Strike , K-1 World Grand Prix 2006" authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4405" title="add NearestEErounding to SSX and SSX tricky" authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4462" title="Add Kickstartfor Rayman Raving Rabbids." authors="icup321" >}}

{{< progress/github-link prNum="4478" title="Adds VUclamping mode extra to Enthusia Professional Racing" authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4488" title="Remove nolonger needed 'OPHFLagHack' for Naruto - Uzumaki Chronicles 2" authors="Mrlinkwii" >}}

## Misc Improvements

{{< progress/github-link prNum="4278" title="Grayout InstantVU1 when MTVU is enabled." authors="RedDevilus" >}}

{{< progress/github-link prNum="4377" title="Revise consolewith newline on compile + title" authors="RedDevilus" >}}

{{< progress/github-link prNum="4416" title="Swap buttonsBrowse... and Ask when booting and default to unchecked state" authors="RedDevilus" >}}

{{< progress/github-link prNum="4378" title="change window todebug in the menu and move blockdump to the debug menu" authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4431" title="update the 2smaller app icons." authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4438" title="change 'Consoleto Stdio' to 'Program Log to Stdio' in UI" authors="Mrlinkwii" >}}

{{< progress/github-link prNum="4454" title="Rename PSXreferences to PS1 distinguish between PS1 and DVR" authors="Florin9doi" >}}

{{< progress/github-link prNum="4329" title="RemoveSSE2/SSE3 support" authors="GovanifY" >}}

Moving forward with our goal to clean up and modernize the code we are
removing SSE2/3 support.

{{< progress/github-link prNum="4444" title="Save ELF lastpath when auto-running an elf" authors="F0bes" >}}

{{< progress/github-link prNum="4343" title="Enable GSdebugger on CI artifacts" authors="lightningterror" >}}
...
{{< progress/github-link prNum="4418" title="Validate GameDBchanges in GitHub Actions." authors="xTVaser" >}}
...
{{< progress/github-link prNum="4180" title="CI: Add an explicit flag to retain debugging artifacts (.pdb, .exp, .lib, etc) in Windows builds." authors="xTVaser" >}}
